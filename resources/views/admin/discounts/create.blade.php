...
@section('title', 'Create Discount - ' . config('app.name') . ' Admin')
...
<div class="w-full">
    ...
    <div class="mb-8 flex items-center gap-3">
        ...
        <div>
            <h1 class="text-3xl font-bold text-slate-900 dark:text-slate-100">Create Discount</h1>
            <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">Add a new discount code</p>
        </div>
    </div>

    <!-- Form Card -->
    <div class="admin-card p-8">
        <form method="POST" action="{{ route('admin.discounts.store') }}" class="space-y-8">
            @csrf
